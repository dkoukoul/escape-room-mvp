...
export namespace Prisma {
  ...
  */
  ...
  export type GameScoreOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "roomName" | "userNames" | "playedAt" | "timeRemaining" | "glitches" | "score" | "createdAt" | "updatedAt", ExtArgs["result"]["gameScore"]>
  ...
  interface GameScoreFieldRefs {
    ...
    readonly roomName: FieldRef<"GameScore", 'String'>
    readonly userNames: FieldRef<"GameScore", 'String[]'>
    readonly playedAt: FieldRef<"GameScore", 'DateTime'>
    readonly timeRemaining: FieldRef<"GameScore", 'Int'>
    readonly glitches: FieldRef<"GameScore", 'Int'>
    readonly score: FieldRef<"GameScore", 'Int'>
    readonly createdAt: FieldRef<"GameScore", 'DateTime'>
    readonly updatedAt: FieldRef<"GameScore", 'DateTime'>
  }
  ...
  export type GameScoreWhereInput = {
    ...
    roomName?: StringFilter<"GameScore"> | string
    userNames?: StringNullableListFilter<"GameScore">
    playedAt?: DateTimeFilter<"GameScore"> | Date | string
    timeRemaining?: IntFilter<"GameScore"> | number
    glitches?: IntFilter<"GameScore"> | number
    score?: IntFilter<"GameScore"> | number
    createdAt?: DateTimeFilter<"GameScore"> | Date | string
    updatedAt?: DateTimeFilter<"GameScore"> | Date | string
  }
  ...
  export type GameScoreScalarWhereWithAggregatesInput = {
    ...
    roomName?: StringWithAggregatesFilter<"GameScore"> | string
    userNames?: StringNullableListFilter<"GameScore">
    playedAt?: DateTimeWithAggregatesFilter<"GameScore"> | Date | string
    timeRemaining?: IntWithAggregatesFilter<"GameScore"> | number
    glitches?: IntWithAggregatesFilter<"GameScore"> | number
    score?: IntWithAggregatesFilter<"GameScore"> | number
    createdAt?: DateTimeWithAggregatesFilter<"GameScore"> | Date | string
    updatedAt?: DateTimeWithAggregatesFilter<"GameScore"> | Date | string
  }

  export type GameScoreCreateInput = {
    id?: string
    roomName: string
    userNames?: GameScoreCreateuserNamesInput | string[]
  ...
  export type GameScoreCreateuserNamesInput = {
    set: string[]
  }
  ...
  export type GameScoreUpdateuserNamesInput = {
    set?: string[]
    push?: string | string[]
  }
